...
public class ForgeMixinConfigPlugin implements IMixinConfigPlugin {
    ...
    public boolean shouldApplyMixin(String targetClassName, String mixinClassName) {
        if (mixinClassName.equals("net.drolededragon.hexenergies.forge.mixin.MixinDatagenMain")) {
            var shouldApply = System.getProperty("hexenergies.apply-datagen-mixin", "false").equals("true");
            if (shouldApply) {
                Hexenergies.LOGGER.warn("Applying scuffed datagen mixin. This should not happen if not running datagen!");
            }
            return shouldApply;
        }
        return true;
