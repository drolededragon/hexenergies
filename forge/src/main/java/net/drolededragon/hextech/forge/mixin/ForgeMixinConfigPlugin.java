...
public class ForgeMixinConfigPlugin implements IMixinConfigPlugin {
    ...
    public boolean shouldApplyMixin(String targetClassName, String mixinClassName) {
        if (mixinClassName.equals("net.drolededragon.hextech.forge.mixin.MixinDatagenMain")) {
            var shouldApply = System.getProperty("hextech.apply-datagen-mixin", "false").equals("true");
            if (shouldApply) {
                Hextech.LOGGER.warn("Applying scuffed datagen mixin. This should not happen if not running datagen!");
            }
            return shouldApply;
        }
        return true;
