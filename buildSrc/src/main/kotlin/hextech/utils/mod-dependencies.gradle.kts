...
abstract class HextechModDependenciesExtension(private val project: Project) {
...
val extension = extensions.create<HextechModDependenciesExtension>("hextechModDependencies")
