...
loom {
    ...
    accessWidenerPath = project(":common").file("src/main/resources/hextech.accesswidener")

    mixin {
        // the default name includes both archivesName and the subproject, resulting in the platform showing up twice
        // default: hextech-common-common-refmap.json
        // fixed:   hextech-common.refmap.json
