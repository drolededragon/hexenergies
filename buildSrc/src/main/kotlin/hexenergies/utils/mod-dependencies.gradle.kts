...
abstract class HexenergiesModDependenciesExtension(private val project: Project) {
...
val extension = extensions.create<HexenergiesModDependenciesExtension>("hexenergiesModDependencies")
