...
loom {
    ...
    accessWidenerPath = project(":common").file("src/main/resources/hexenergies.accesswidener")

    mixin {
        // the default name includes both archivesName and the subproject, resulting in the platform showing up twice
        // default: hexenergies-common-common-refmap.json
        // fixed:   hexenergies-common.refmap.json
