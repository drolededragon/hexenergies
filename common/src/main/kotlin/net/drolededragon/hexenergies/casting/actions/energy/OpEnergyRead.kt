...
import net.drolededragon.hexenergies.getEnergyStored
import net.drolededragon.hexenergies.getMaxEnergyStored
...
object OpEnergyRead : ConstMediaAction {
    ...
    override fun execute(args: List<Iota>, env: CastingEnvironment): List<Iota> {
        ...
        if (!env.world.isInWorldBounds(blockPos)) {
            throw MishapBadLocation(position, "hexenergies.energy_read.out_of_bounds")
        }
