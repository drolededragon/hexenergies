package net.drolededragon.hexenergies.config
...
import net.drolededragon.hexenergies.networking.msg.MsgSyncConfigS2C

object HexenergiesConfig {
    @JvmStatic
